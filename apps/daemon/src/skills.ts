...
export async function listSkills(skillsRoot) {
  ...
  for (const entry of entries) {
    ...
    try {
      ...
      // Sanitize before any other transformation: HTML comments, script/style
      // tags, stealth Unicode, and over-budget bodies are all
      // prompt-injection vectors per docs/prompt-engineering.md Layer 3.
