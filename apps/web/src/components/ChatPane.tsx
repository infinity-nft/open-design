...
interface Props {
  ...
  // Auto-revise on a lint findings card sends the daemon's pre-rendered
  // <artifact-lint-summary> block back to the agent as a user turn so it
  // can self-correct without the user typing the diagnosis.
  ...
  // Daemon-vs-API mode controls whether the connectivity badge runs.
...
export function ChatPane({
  ...
  return (
    <div className="pane">
      {execMode ? <DaemonHealthBadge mode={execMode} /> : null}
